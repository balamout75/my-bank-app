...
- Prometeus - это про метрики, Kibana - это про логи. В принципе, задачи можно решать одинаковые. Результаты notifacation сейчас идут в Kibana, но можно было бы направить и в Grafana/
